...
<html lang="es">
    ...
    <body>
        ...
        <main>
            <form action="Registro" method="post" class="registro login" enctype="multipart/form-data">
                <h1 style="border-bottom: black solid 1px;">Iniciar sesión</h1>
                ...
                <input type="submit" name="boton" value="Entrar" id="boton">
            </form>
        </main>
