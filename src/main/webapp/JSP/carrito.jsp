                        ...
                        <div class="col">
                            <div class="card">
                                <form action="CarritoController" method="post">
                                    <button type="submit" id="eliminar" class=" btnAccion eliminarBtn position-absolute" style="width: 50px; right: 0;" value="Eliminar" name="boton">
                                        🚯
                                    </button>
                                </form>
                                <span class="eliminar">Eliminar carro</span>
                                                    ...
                                                    <div class="card mb-3 producto" id="${lpedido.producto.idProducto}">
                                                        <div class="card-body d-flex row text-center ">
                                                            ...
                                                            <div class="col-6 col-md-3">
                                                                ...
                                                                <button type="button" id="mas" class="btnAccion accion" value="${lpedido.producto.idProducto}">
                                                                    ⬆
                                                                </button>

                                                                <button type="button" id="menos" class="btnAccion accion" value="${lpedido.producto.idProducto}" >
                                                                    ⬇
                                                                </button>

                                                                <button type="button" id="eliminar" class="btnAccion accion" value="${lpedido.producto.idProducto}">
                                                                    ❌
                                                                </button>
